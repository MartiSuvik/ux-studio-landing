...
const Carousel: React.FC<PropType> = (props) => {
  ...
  return (
    <div className="">
      <div className="overflow-hidden" ref={emblaRef}>
        <div className="flex touch-pan-y touch-pinch-zoom ml-auto mr-3">
          {slides.map((slideContent, index) => (
            <div className="flex-[0_0_85%] md:flex-[0_0_60%] lg:flex-[0_0_50%] pl-4 md:pl-6 transform-gpu" key={index}>
              {slideContent}
            </div>
          ))}
        </div>
      ...
      <div className="flex mx-auto max-w-sm justify-between items-center gap-3 mt-8">
